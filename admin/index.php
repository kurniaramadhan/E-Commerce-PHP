...
<?php
    ...
    $query_total_paid = "SELECT COUNT(*) AS total_paid FROM orders WHERE order_status = 'paid'";
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Total Payment</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">$<?php if (isset($total_payments)) { echo $total_payments; } ?></div>
                                        </div>
                                        <div class="col-auto">
